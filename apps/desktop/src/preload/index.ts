...
const api: RevyApi = {
  ...
  deleteReviewerProfile: (profileId) =>
    ipcRenderer.invoke(ipcChannels.reviewerProfileDelete, profileId),
  deleteReview: (reviewId) => ipcRenderer.invoke(ipcChannels.reviewDelete, reviewId),
  deleteWorkflow: (workflowId) => ipcRenderer.invoke(ipcChannels.workflowDelete, workflowId),
  ...
  saveReviewerProfile: (input) => ipcRenderer.invoke(ipcChannels.reviewerProfileSave, input),
  saveWorkflow: (input) => ipcRenderer.invoke(ipcChannels.workflowSave, input),
